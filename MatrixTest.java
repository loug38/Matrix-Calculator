public class MatrixTest{
	public static void main(String[] args){
	     ...
	     // A.changeEntry(1,2,1); B.changeEntry(1,2,1);
	     // A.changeEntry(1,3,1); B.changeEntry(1,3,1);
	     // A.changeEntry(2,1,1); B.changeEntry(2,1,1);
	     // A.changeEntry(2,2,1); B.changeEntry(2,2,1);
	     // A.changeEntry(2,3,1); B.changeEntry(2,3,1);
	     // A.changeEntry(3,1,1); B.changeEntry(3,1,1);
	     // A.changeEntry(3,2,1); B.changeEntry(3,2,1);
	     // A.changeEntry(3,3,1); B.changeEntry(3,3,1);
	      *
	      *
	     // A.changeEntry(1,1,1000); B.changeEntry(1,1,1);
	     // A.changeEntry(1,2,230); B.changeEntry(1,2,0);
	     // A.changeEntry(1,3,340); B.changeEntry(1,3,1);
	     // A.changeEntry(2,1,50); B.changeEntry(2,1,0);
